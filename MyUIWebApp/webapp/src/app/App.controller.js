sap.ui.define(
  ...
  function(BaseController, MessageToast, RestModel, formatter) {
    ...
    return BaseController.extend('MyUIWebApp.src.app.App', {
      fmt: formatter,
      _toolPage: {},
      onInit: function() {
      ...
      loggedPopOver: function(oEvent) {
        if (!this._oPopoverLogged) {
          this._oPopoverLogged = sap.ui.xmlfragment(
            'MyUIWebApp.src.pages.security.Logged',
            this
          );
      ...
      createNavigation() {
        ...
        const sideMenu = sap.ui.xmlfragment('MyUIWebApp.src.app.SideMenu', this);
