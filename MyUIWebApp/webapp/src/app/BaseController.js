sap.ui.define(
  [
    ...
    'MyUIWebApp/src/pages/exceptions/Exeption.controller',
    'MyUIWebApp/model/formatter',
    'MyUIWebApp/model/RestModel'
  ],
  function(Controller, Exeption, formatter, RestModel) {
    'use strict';

    return Controller.extend('MyUIWebApp.src.app.BaseController', {
      fmt: formatter,
      ...
      getLocalSettings() {
        const localSettings = this.getItem(this.LOCAL_SETTINGS_PATH) || {
      ...
      getServerUrl() {
        let base = [];
        let serve = this.getOwnerComponent()
          .getMetadata()
