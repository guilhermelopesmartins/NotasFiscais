sap.ui.define(
  ...
  function(BaseController, RestModel, Filter) {
    ...
    return BaseController.extend('MyUIWebApp.src.pages.languages.Languages', {
      onInit: function() {
        this.getRouter()
          .getRoute('languages')
      ...
      CreateArrayFrom119nModel() {
        let resource = this.getOwnerComponent()
          .getModel('i18n')
          .getResourceBundle();
      ...
      markToEdit(oEvent) {
        ...
        let custom = this.getModel('Custom')
          .getData()
          .filter(x => x.key != prop.key);
