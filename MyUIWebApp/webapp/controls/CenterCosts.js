sap.ui.define(['sap/ui/core/Control', 'MyUIWebApp/model/formatter'], function(
  Control,
  formatter
) {
  'use strict';
  return Control.extend('MyUIWebApp.controls.CenterCosts', {
    metadata: {
      properties: {
    ...
    init: function() {
      this.cssEtyle =
        'padding: 1px 2px 1px 1px; background: #227093; border-radius: 3px;display: inline;	line-height: 1.5em;margin-right: 2px;color: #FFF;';
    },
    ...
    renderer: function(oRM, oControl) {
      ...
      if (formatter.dimActive(oControl.getCenterCost().Active)) {
        ...
        oRM.write('</span>');
        if (oControl.getBreakLine()) oRM.write('<br>');
      }
