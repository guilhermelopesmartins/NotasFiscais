  ...
  function o(t, e) {
    ...
    (this.velocityFilterWeight = s.velocityFilterWeight || 0.7),
      ...
      (this._handleMouseDown = function(t) {
        t.which === 1 && ((n._mouseButtonDown = !0), n._strokeBegin(t));
      }),
  ...
  return (
    ...
    (o.prototype._strokeBegin = function(t) {
      this._data.push([]),
        ...
        typeof this.onBegin === 'function' && this.onBegin(t);
    }),
        ...
        if (s.length > 1)
          for (var r = 0; r < s.length; r += 1) {
            var h = s[r],
              ...
              c = h.color;
            if (r === 0) (this.penColor = c), this._reset(), this._addPoint(a);
        ...
        this._fromData(
          ...
          function(e) {
            var i = document.createElement('circle'),
              o = typeof t.dotSize === 'function' ? t.dotSize() : t.dotSize;
            i.setAttribute('r', o),
