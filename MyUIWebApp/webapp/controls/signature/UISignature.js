sap.ui.define(
  ['sap/ui/core/Control', 'MyUIWebApp/controls/signature/signature_pad'],
  function(Control, SignaturePadjs) {
    'use strict';
    return Control.extend('MyUIWebApp.controls.signature.UISignature', {
      signaturePad: null,
      metadata: {
        properties: {
      ...
      clear: function() {
        if (this.signaturePad) {
          ...
          console.error(
            'signaturePad não inicializado, é necessário chamar o método activate(), após a renderização da view.'
          );
      },
      toDataURL: function() {
