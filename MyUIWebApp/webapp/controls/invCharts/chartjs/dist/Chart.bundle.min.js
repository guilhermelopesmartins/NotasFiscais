...
!(function(t, e) {
  ...
  for (var D in t) {
    S[D + 'Raw'] = (function(e) {
      return function(i) {
        return (
          typeof i === 'number' && (i = Array.prototype.slice.call(arguments)), t[e](i)
        );
      };
    })(D);
    var C = /(\w+)2(\w+)/.exec(D),
    ...
    (S[P] = S[P] || {})[T] = S[D] = (function(e) {
      return function(i) {
        typeof i === 'number' && (i = Array.prototype.slice.call(arguments));
        var n = t[e](i);
  ...
  (j.prototype = {
    ...
    (j.prototype.setValues = function(t, e) {
      ...
      if (
        ((a.alpha = Math.max(0, Math.min(1, void 0 === s ? a.alpha : s))), t === 'alpha')
      )
        return !1;
                  ...
                  value: function() {
                    ...
                    return (
                      ut.each(t._chartjs.listeners, function(t) {
                        typeof t[i] === 'function' && t[i].apply(t, e);
                      }),
                      a
                    );
                  }
  ...
  var wt = gt.extend({
      inLabelRange: function(t) {
        var e = this._view;
        return Boolean(e) && Math.pow(t - e.x, 2) < Math.pow(e.radius + e.hoverRadius, 2);
      },
  ...
  function Wt(t, e, i) {
    var n = e === null,
      ...
      r = !(!t || (n && a)) && Ft(t);
    return (
      r && (n || (e >= r.left && e <= r.right)) && (a || (i >= r.top && i <= r.bottom))
    );
  }
  ot._set('global', {
    elements: {
  ...
  var Xt = kt.extend({
    ...
    updateElement: function(t, e, i) {
      ...
      var v = t._model;
      (i && s.animateRotate) ||
        ((v.startAngle = e === 0 ? o.rotation : n.getMeta().data[e - 1]._model.endAngle),
    ...
    getMaxBorderWidth: function(t) {
      ...
      for (e = 0, i = t.length; e < i; ++e)
        (a = t[e]),
          (o = r ? r._resolveElementOptions(a, e) : a._options).borderAlign !== 'inner' &&
            ((s = o.borderWidth),
  ...
  var ie = kt.extend({
      ...
      update: function(t) {
        ...
        for (
          u && r._model.tension !== 0 && n.updateBezierControlPoints(),
            e = 0,
            i = o.length;
          e < i;
          ++e
  ...
  function We(t, e, i) {
    var n,
      ...
      l = (s.resizer = (function(t) {
        ...
        return (
          Ae(i, 'scroll', a.bind(i, 'expand')), Ae(n, 'scroll', a.bind(n, 'shrink')), e
        );
      })(
        ((n = function() {
          if (s.resizer) {
  ...
  var Ne = {
    ...
    acquireContext: function(t, e) {
      typeof t === 'string' ? (t = document.getElementById(t)) : t.length && (t = t[0]),
  ...
  var Xe = gt.extend({
          ...
          for (e = 0, i = m.length; e < i; ++e)
            w.push(
              ...
              (d = l._getValueScale()),
              {
                ...
                label: u ? String(u.getLabelForIndex(o, s)) : '',
                value: d ? String(d.getLabelForIndex(o, s)) : '',
                index: o,
                datasetIndex: s,
                x: n._model.x,
                y: n._model.y
      ...
      drawBody: function(t, e, i) {
        ...
        (i.fillStyle = e.bodyFontColor),
          ...
          (d = l && o !== 'right' ? (o === 'center' ? a / 2 + 1 : a + 2) : 0),
      ...
      merger: function(t, e, i, n) {
        if (t === 'xAxes' || t === 'yAxes') {
          ...
          for (e[t] || (e[t] = []), a = 0; a < s; ++a)
            (o = i[t][a]),
              (r = Qe(o.type, t === 'xAxes' ? 'category' : 'linear')),
          ...
          if (
            ...
            if (p)
              (R = e.left + (e.right - e.left) / 2),
                (L = f === 'bottom' ? e.bottom - Y - T.bottom : e.top + Y + T.top);
            else {
              var N = f === 'left';
  ...
  var yi = fi.extend({
    ...
    xi = yi.extend({
      ...
      getLabelForIndex: function(t, e) {
        return Number(this.getRightValue(this.chart.data.datasets[e].data[t]));
      },
  ...
  var Si = fi.extend({
            ...
            ut.each(s, function(e) {
              if (e.length > 0) {
                ...
                (t.min = t.min === null ? i : Math.min(t.min, i)),
                  (t.max = t.max === null ? n : Math.max(t.max, n));
              }
            });
        } else
          ut.each(n, function(e, n) {
        ...
        (t.min = Mi(e.min, t.min)),
          ...
          t.min === t.max &&
            (t.min !== 0 && t.min !== null
              ...
              : ((t.min = 1), (t.max = 10))),
          t.min === null && (t.min = Math.pow(10, Math.floor(ut.log10(t.max)) - 1)),
          t.max === null &&
            (t.max = t.min !== 0 ? Math.pow(10, Math.floor(ut.log10(t.min)) + 1) : 10),
          t.minNotZero === null &&
            (t.min > 0
              ? (t.minNotZero = t.min)
              : t.max < 1
      ...
      getPixelForValue: function(t) {
        ...
        return (
          ...
          t !== n &&
            (n === 0 && ((e -= h = ki(s.fontSize, ot.global.defaultFontSize)), (n = d)),
  ...
  function Zi(t, e) {
    ...
    return (
      ...
      ut.isFinite(o) || (o = typeof r === 'string' ? i.parse(o, r) : i.parse(o)),
      o !== null
        ? Number(o)
        : (a ||
            typeof r !== 'function' ||
  ...
  function $i(t, e) {
    ...
    return n === null ? n : (i.round && (n = Number(t._adapter.startOf(n, i.round))), n);
  }
  function Xi(t) {
  ...
  function Ki(t, e, i, n) {
    ...
    for (
      d ||
        ...
        (m = Number(r.startOf(m, h ? 'day' : l))) < i && (m = Number(r.add(m, 1, l))),
        a = g,
        c &&
          u &&
          !h &&
  ...
  var Ji = fi.extend({
      ...
      buildTicks: function() {
        ...
        for (
          o.bounds === 'ticks' && l.length && ((a = l[0]), (r = l[l.length - 1])),
            a = $i(n, s.min) || a,
            r = $i(n, s.max) || r,
            t = 0,
            e = l.length;
        ...
        return (
          ...
          (n._offsets = (function(t, e, i, n, a) {
            ...
            return (
              a.offset &&
                ...
                (a.time.min ||
                  ((r = qi(t, 'time', e[0], 'pos')),
                  (s = e.length === 1 ? 1 - r : (qi(t, 'time', e[1], 'pos') - r) / 2)),
                a.time.max ||
          ...
          (function(t, e, i) {
            ...
            for (n = 0, a = e.length; n < a; ++n)
              (r = e[n]),
                (o = Boolean(i) && r === Number(t._adapter.startOf(r, i))),
  ...
  var tn,
    ...
    nn = ((function(t, e) {
      t.exports = (function() {
        ...
        function m(t) {
          var e = c(NaN);
          return t != null ? h(f(e), t) : (f(e).userInvalidated = !0), e;
        }
        ...
        function S(t, e) {
          var i = !0;
          return h(function() {
            if ((n.deprecationHandler != null && n.deprecationHandler(null, t), i)) {
        ...
        var D,
          C = {};
        function P(t, e) {
          n.deprecationHandler != null && n.deprecationHandler(t, e),
            C[t] || (M(e), (C[t] = !0));
        }
        function T(t) {
          return (
        ...
        function R(t) {
          return typeof t === 'string' ? A[t] || A[t.toLowerCase()] : void 0;
        }
        function L(t) {
          var e,
            i,
        ...
        B('Y', 0, 0, function() {
          ...
          ft('YYYY', function(t, e) {
            e[pt] = t.length === 2 ? n.parseTwoDigitYear(t) : k(t);
          }),
          ft('YY', function(t, e) {
        ...
        function It(t, e, i) {
          t.isValid() &&
            !isNaN(i) &&
            (e === 'FullYear' && Dt(t.year()) && t.month() === 1 && t.date() === 29
        ...
        function At(t, e) {
          ...
          var i,
            n = (e % (i = 12) + i) % i;
          return (t += (e - n) / 12), n === 1 ? (Dt(t) ? 29 : 28) : 31 - (n % 7) % 2;
        }
        ...
        B('H', ['HH', 2], 0, 'hour'),
          ...
          B('hmm', 0, 0, function() {
            return String(te.apply(this)) + N(this.minutes(), 2);
          }),
          B('hmmss', 0, 0, function() {
            return String(te.apply(this)) + N(this.minutes(), 2) + N(this.seconds(), 2);
          }),
          B('Hmm', 0, 0, function() {
            return String(this.hours()) + N(this.minutes(), 2);
          }),
          B('Hmmss', 0, 0, function() {
            return String(this.hours()) + N(this.minutes(), 2) + N(this.seconds(), 2);
          }),
          ee('a', !0),
          ee('A', !1),
          F('hour', 'h'),
        ...
        function he(t, e) {
          if (e !== null) {
            ...
            if (((e.abbr = t), oe[t] != null))
              ...
              if (oe[e.parentLocale] != null) n = oe[e.parentLocale]._config;
              else {
          ...
          if (!t._d) {
            for (
              a = (function(t) {
                ...
                t._dayOfYear != null &&
                  ((o = ge(t._a[pt], a[pt])),
                  (t._dayOfYear > St(o) || t._dayOfYear === 0) &&
        ...
        function Re(t, e) {
          var i, n;
          if ((e.length === 1 && a(e[0]) && (e = e[0]), !e.length)) return Ie();
        ...
        function We(t) {
          ...
          (this._isValid = (function(t) {
            for (var e in t)
              if (Ct.call(Le, e) === -1 || (t[e] != null && isNaN(t[e]))) return !1;
            ...
            (this._milliseconds = Number(d) + 1e3 * u + 6e4 * l + 1e3 * s * 60 * 60),
        ...
        function ze(t, e) {
          B(t, 0, 0, function() {
            var t = this.utcOffset(),
              i = '+';
            return (
              t < 0 && ((t = -t), (i = '-')), i + N(~~(t / 60), 2) + e + N(~~t % 60, 2)
            );
          });
        }
        ze('Z', ':'),
        ...
        function je() {
          return Boolean(this.isValid()) && this._isUTC && this._offset === 0;
        }
        ...
        function $e(t, e) {
          ...
          return (
            ...
            t
              ...
              .add(i.months, 'M')
              .isAfter(e) && --i.months,
            (i.milliseconds = Number(e) - Number(t.clone().add(i.months, 'M'))),
            i
          );
        }
        function Xe(t, e) {
          return function(i, n) {
            ...
            return (
              n === null ||
                ...
                (i = n),
                (n = a)),
              Ke(this, qe((i = typeof i === 'string' ? Number(i) : i), n), t),
              this
            );
          };
        }
        ...
        (bi.add = Je),
          ...
          (bi.endOf = function(t) {
            var e;
            if (void 0 === (t = R(t)) || t === 'millisecond' || !this.isValid())
              return this;
          ...
          (bi.isBetween = function(t, e, i, n) {
            var a = x(t) ? t : Ie(t),
              r = x(e) ? e : Ie(e);
            return (
              Boolean(this.isValid() && a.isValid() && r.isValid()) &&
        ...
        function wi(t, e, i) {
          if ((s(t) && ((e = t), (t = void 0)), (t = t || ''), e != null))
          ...
          (_i.monthsParse = function(t, e, i) {
            ...
            if (this._monthsParseExact)
              return function(t, e, i) {
                ...
                return i
                  ? e === 'MMM'
                    ? (a = Ct.call(this._shortMonthsParse, o)) !== -1
                      ? a
                      : null
                    : (a = Ct.call(this._longMonthsParse, o)) !== -1
                      ? a
                      : null
                  : e === 'MMM'
                    ? (a = Ct.call(this._shortMonthsParse, o)) !== -1
          ...
          (_i.weekdaysParse = function(t, e, i) {
            ...
            if (this._weekdaysParseExact)
              return function(t, e, i) {
                ...
                return i
                  ? e === 'dddd'
                    ? (a = Ct.call(this._weekdaysParse, o)) !== -1
                      ? a
                      : null
                    : e === 'ddd'
                      ? (a = Ct.call(this._shortWeekdaysParse, o)) !== -1
                        ? a
                        : null
                      : (a = Ct.call(this._minWeekdaysParse, o)) !== -1
                        ? a
                        : null
                  : e === 'dddd'
                    ? (a = Ct.call(this._weekdaysParse, o)) !== -1
        ...
        return (
            ...
            var e = this.localeData(),
              i = (function(t, e, i) {
                ...
                return (
                  ...
                  (d[4] = i),
                  function(t, e, i, n, a) {
                    return a.relativeTime(e || 1, Boolean(i), t, n);
                  }.apply(null, d)
                );
              })(this, !t, e);
            return t && (i = e.pastFuture(Number(this), i)), e.postformat(i);
          }),
          (Qi.toISOString = Ji),
          (Qi.toString = Ji),
          (Qi.toJSON = Ji),
          ...
          (n.relativeTimeRounding = function(t) {
            return void 0 === t ? Zi : typeof t === 'function' && ((Zi = t), !0);
          }),
          (n.relativeTimeThreshold = function(t, e) {
            return (
              void 0 !== $i[t] &&
              (void 0 === e ? $i[t] : (($i[t] = e), t === 's' && ($i.ss = e - 1), !0))
            );
          }),
    ...
    typeof nn === 'function'
      ? {
          ...
          startOf: function(t, e, i) {
            return (
              (t = nn(t)),
              e === 'isoWeek' ? t.isoWeekday(i).valueOf() : t.startOf(e).valueOf()
            );
          },
          endOf: function(t, e) {
            return nn(t)
  ...
  function on(t, e, i) {
    var n,
      a = t._model || {},
      r = a.fill;
    if ((void 0 === r && (r = Boolean(a.backgroundColor)), !1 === r || r === null))
      return !1;
          ...
          s &&
            ...
            (function(t, e, i, n, a, r) {
              var o,
                ...
                v = 0,
                y = 0;
              for (t.beginPath(), o = 0, s = f + Boolean(r); o < s; ++o)
        ...
        if (((a.font = r.string), u)) {
          ...
          (a.textAlign = 'left'),
            ...
            ut.each(t.legendItems, function(t, e) {
              ...
              (e === 0 || d[d.length - 1] + n + i.padding > l.width) &&
          ...
          m
            ...
            (function(t, i, n) {
              if (!(isNaN(f) || f <= 0)) {
                ...
                } else o !== 0 && u.strokeRect(t, i, f, c), u.fillRect(t, i, f, c);
                u.restore();
              }
            })(y, b, n),
            (g[d].left = y),
        ...
        for (e = 0; e < h; ++e)
          if (!(n = d[e]).model.skip) {
            if (
              ...
              n.deltaK = c !== 0 ? (a.model.y - n.model.y) / c : 0;
            }
            !i || i.model.skip
              ? (n.mK = n.deltaK)
              : !a || a.model.skip
          ...
          e != null && !0 !== ut.isArray(e)
            ...
            : ut.isArray(e) &&
              ut.each(e, function(e) {
                e == null || ut.isArray(e) || (o = ut.measureText(t, a, r, o, e));
              });
        });
        var s = r.length / 2;
        if (s > i.length) {
