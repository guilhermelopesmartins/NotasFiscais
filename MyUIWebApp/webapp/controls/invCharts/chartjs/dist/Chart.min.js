...
!(function(t, e) {
  ...
  for (var P in e) {
    S[P + 'Raw'] = (function(t) {
      return function(i) {
        return (
          typeof i === 'number' && (i = Array.prototype.slice.call(arguments)), e[t](i)
        );
      };
    })(P);
    var I = /(\w+)2(\w+)/.exec(P),
  ...
  function O(t) {
    if (t) {
      ...
      return (i = i || i == 0 ? E(i, 0, 1) : 1), (e[3] = i), e;
    }
  }
  function z(t) {
    if (t) {
    ...
    at = {
      ...
      drawPoint: function(t, e, i, n, a, o) {
        ...
        if (
          !e ||
          typeof e !== 'object' ||
          ((r = e.toString()) !== '[object HTMLImageElement]' &&
  ...
  var dt = {
      ...
      resolve: function(t, e, i) {
        ...
        for (n = 0, a = t.length; n < a; ++n)
          if (
            void 0 !== (o = t[n]) &&
            (void 0 !== e && typeof o === 'function' && (o = o(e)),
  ...
  var bt = {
      ...
      addAnimation: function(t, e, i, n) {
        ...
        r.push(e), r.length === 1 && this.requestAnimationFrame();
      },
  ...
  function Bt(t, e, i) {
    var n = e === null,
      ...
      o = !(!t || (n && a)) && Rt(t);
    return (
      o && (n || (e >= o.left && e <= o.right)) && (a || (i >= o.top && i <= o.bottom))
    );
  }
  st._set('global', {
    elements: {
  ...
  var Yt = Mt.extend({
      ...
      _getStacks: function(t) {
        ...
        for (e = 0; e < o; ++e)
          (i = n.getDatasetMeta(e)).bar &&
            ...
            (!1 === a ||
              (!0 === a && r.indexOf(i.stack) === -1) ||
              (void 0 === a && (void 0 === i.stack || r.indexOf(i.stack) === -1))) &&
            r.push(i.stack);
        return r;
      },
      ...
      calculateBarValuePixels: function(t, e) {
        var i,
          ...
          h = u.isHorizontal(),
          c = l.data.datasets,
          f = Number(u.getRightValue(c[t].data[e])),
        ...
        if (p || (void 0 === p && void 0 !== m))
          for (i = 0; i < t; ++i)
            (n = l.getDatasetMeta(i)).bar &&
              ...
              ((a = Number(u.getRightValue(c[i].data[e]))),
              ((f < 0 && a < 0) || (f >= 0 && a > 0)) && (v += a));
        return (
          ...
          a =
            n.barThickness === 'flex'
              ? (function(t, e, i) {
                  ...
                  return (
                    r === null && (r = o - (s === null ? e.end - e.start : s - o)),
                    s === null && (s = o + o - r),
      ...
      updateElement: function(t, e, i) {
        var n = this,
          ...
          h = i
            ...
            : r.getPixelForValue(typeof d === 'object' ? d : NaN, e, u),
  ...
  var $t = Mt.extend({
    ...
    updateElement: function(t, e, i) {
      ...
      var v = t._model;
      (i && s.animateRotate) ||
        ((v.startAngle = e === 0 ? r.rotation : n.getMeta().data[e - 1]._model.endAngle),
    ...
    getMaxBorderWidth: function(t) {
      ...
      for (e = 0, i = t.length; e < i; ++e)
        (a = t[e]),
          (r = o ? o._resolveElementOptions(a, e) : a._options).borderAlign !== 'inner' &&
            ((s = r.borderWidth),
  ...
  var ne = Mt.extend({
      ...
      update: function(t) {
        ...
        for (
          d && o._model.tension !== 0 && n.updateBezierControlPoints(),
            e = 0,
            i = r.length;
          e < i;
          ++e
      ...
      updateElement: function(t, e, i) {
        ...
        (n = c.getPixelForValue(typeof u === 'object' ? u : NaN, e, d)),
      ...
      calculatePointY: function(t, e, i) {
        ...
        if (l.options.stacked) {
          for (n = 0; n < i; n++)
            if (
              ((a = r.data.datasets[n]),
              (o = r.getDatasetMeta(n)).type === 'line' &&
                o.yAxisID === l.id &&
  ...
  var Ee = {
      ...
      notify: function(t, e, i) {
        ...
        for (n = 0; n < d; ++n)
          if (
            typeof (s = (o = (a = l[n]).plugin)[e]) === 'function' &&
  ...
  var Ze = pt.extend({
          ...
          for (e = 0, i = p.length; e < i; ++e)
            M.push(
              ...
              (u = l._getValueScale()),
              {
                ...
                label: d ? String(d.getLabelForIndex(r, s)) : '',
                value: u ? String(u.getLabelForIndex(r, s)) : '',
                index: r,
                datasetIndex: s,
                x: n._model.x,
                y: n._model.y
          ...
          c.filter &&
            ...
            (b = (function(t, e, i, n) {
              ...
              return (
                ...
                u === 'top'
                  ? (o += h)
                  : (o -= u === 'bottom' ? e.height + h : e.height / 2),
                u === 'center'
                  ? d === 'left'
                    ? (a += h)
                    : d === 'right' && (a -= h)
      ...
      drawBody: function(t, e, i) {
        ...
        (i.fillStyle = e.bodyFontColor),
          ...
          (u = l && r !== 'right' ? (r === 'center' ? a / 2 + 1 : a + 2) : 0),
      ...
      drawBackground: function(t, e, i, n) {
        ...
        i.beginPath(),
          i.moveTo(r + u, s),
          o === 'top' && this.drawCaret(t, n),
          i.lineTo(r + l - u, s),
          i.quadraticCurveTo(r + l, s, r + l, s + u),
          o === 'center' && a === 'right' && this.drawCaret(t, n),
          i.lineTo(r + l, s + d - u),
          i.quadraticCurveTo(r + l, s + d, r + l - u, s + d),
          o === 'bottom' && this.drawCaret(t, n),
          i.lineTo(r + u, s + d),
          i.quadraticCurveTo(r, s + d, r, s + d - u),
          o === 'center' && a === 'left' && this.drawCaret(t, n),
          i.lineTo(r, s + u),
      ...
      merger: function(t, e, i, n) {
        if (t === 'xAxes' || t === 'yAxes') {
          ...
          for (e[t] || (e[t] = []), a = 0; a < s; ++a)
            (r = i[t][a]),
              (o = Qe(r.type, t === 'xAxes' ? 'category' : 'linear')),
          ...
          if (
            ...
            if (m)
              (R = e.left + (e.right - e.left) / 2),
                (O = f === 'bottom' ? e.bottom - B - A.bottom : e.top + B + A.top);
            else {
              var N = f === 'left';
  ...
  var Ci = fi.extend({
      ...
      getPixelForValue: function(t) {
        ...
        return (
          ...
          t !== n &&
            (n === 0 && ((e -= h = wi(s.fontSize, st.global.defaultFontSize)), (n = u)),
            t !== 0 && (h += e / (d(a) - d(n)) * (d(t) - d(n))),
            (i += o * h)),
          i
        );
      },
        ...
        ut.each(e.data.datasets, function(a, o) {
          if (e.isDatasetVisible(o)) {
            ...
            ut.each(a.data, function(e, a) {
              var o = Number(t.getRightValue(e));
              isNaN(o) ||
                r.data[a].hidden ||
  ...
  function Ki(t, e) {
    ...
    return (
      ...
      ut.isFinite(r) || (r = typeof o === 'string' ? i.parse(r, o) : i.parse(r)),
      r !== null
        ? Number(r)
        : (a ||
            typeof o !== 'function' ||
  ...
  function $i(t, e, i, n) {
    ...
    for (
      u ||
        ...
        h &&
          ((g = Number(o.startOf(g, 'isoWeek', h))),
          (p = Number(o.startOf(p, 'isoWeek', h)))),
        g = Number(o.startOf(g, h ? 'day' : l)),
        (p = Number(o.startOf(p, h ? 'day' : l))) < i && (p = Number(o.add(p, 1, l))),
        a = g,
        c &&
          d &&
          !h &&
          !s.round &&
          ((a = Number(o.startOf(a, d))),
          (a = Number(o.add(a, ~~((g - a) / (f.size * u)) * u, l))));
      a < p;
      a = Number(o.add(a, u, l))
    )
      m.push(Number(a));
    return m.push(Number(a)), m;
  }
  var Ji = fi.extend({
      initialize: function() {
      ...
      determineDataLimits: function() {
        ...
        p.length &&
          ...
          (h = Gi(r, d.min) || h),
          (c = Gi(r, d.max) || c),
          (h = h === Hi ? Number(l.startOf(Date.now(), u)) : h),
          (c = c === Ei ? Number(l.endOf(Date.now(), u)) + 1 : c),
          (r.min = Math.min(h, c)),
      ...
      buildTicks: function() {
        ...
        for (
          r.bounds === 'ticks' && l.length && ((a = l[0]), (o = l[l.length - 1])),
            a = Gi(n, s.min) || a,
            o = Gi(n, s.max) || o,
            t = 0,
            e = l.length;
        ...
        return (
          ...
          (n._offsets = (function(t, e, i, n, a) {
            ...
            return (
              a.offset &&
                ...
                (a.time.min ||
                  ((o = Xi(t, 'time', e[0], 'pos')),
                  (s = e.length === 1 ? 1 - o : (Xi(t, 'time', e[1], 'pos') - o) / 2)),
                a.time.max ||
          ...
          (function(t, e, i) {
            ...
            for (n = 0, a = e.length; n < a; ++n)
              (o = e[n]),
                (r = Boolean(i) && o === Number(t._adapter.startOf(o, i))),
    ...
    typeof t === 'function'
      ? {
          ...
          startOf: function(e, i, n) {
            return (
              (e = t(e)),
              i === 'isoWeek' ? e.isoWeekday(n).valueOf() : e.startOf(i).valueOf()
            );
          },
          endOf: function(e, i) {
            return t(e)
  ...
  function an(t, e, i) {
    var n,
      a = t._model || {},
      o = a.fill;
    if ((void 0 === o && (o = Boolean(a.backgroundColor)), !1 === o || o === null))
      return !1;
          ...
          s &&
            ...
            (function(t, e, i, n, a, o) {
              var r,
                ...
                v = 0,
                b = 0;
              for (t.beginPath(), r = 0, s = f + Boolean(o); r < s; ++r)
        ...
        if (((a.font = o.string), d)) {
          ...
          (a.textAlign = 'left'),
            ...
            ut.each(t.legendItems, function(t, e) {
              ...
              (e === 0 || u[u.length - 1] + n + i.padding > l.width) &&
          ...
          p
            ...
            (function(t, i, n) {
              if (!(isNaN(f) || f <= 0)) {
                ...
                } else r !== 0 && d.strokeRect(t, i, f, c), d.fillRect(t, i, f, c);
                d.restore();
              }
            })(b, x, n),
            (g[u].left = b),
        ...
        (e.fillStyle = ut.valueOrDefault(i.fontColor, st.global.defaultFontColor)),
          ...
          t.isHorizontal()
            ...
            : ((a = i.position === 'left' ? h + l : f - l),
              (o = u + (c - u) / 2),
              (n = c - u),
              (d = Math.PI * (i.position === 'left' ? -0.5 : 0.5))),
          e.save(),
          e.translate(a, o),
          e.rotate(d),
          (e.textAlign = 'center'),
          ...
          e != null && !0 !== ut.isArray(e)
            ...
            : ut.isArray(e) &&
              ut.each(e, function(e) {
                e == null || ut.isArray(e) || (r = ut.measureText(t, a, o, r, e));
              });
        });
        var s = o.length / 2;
        if (s > i.length) {
