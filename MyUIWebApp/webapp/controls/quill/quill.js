    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
              ...
              value: function match(evt, binding) {
                ...
                if (
                  ['altKey', 'ctrlKey', 'metaKey', 'shiftKey'].some(function(key) {
                    return Boolean(binding[key]) !== evt[key] && binding[key] !== null;
                  })
                ) {
                  return false;
                }
        ...
        function normalize(binding) {
          ...
          if (
            (typeof binding === 'undefined' ? 'undefined' : _typeof(binding)) === 'object'
          ) {
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var ShadowBlot = /** @class */ (function() {
          ...
          ShadowBlot.prototype.insertAt = function(index, value, def) {
            var blot =
              def == null ? Registry.create('text', value) : Registry.create(value, def);
 ...
 */
        function fix_cursor(diffs, cursor_pos) {
          ...
          if (d_next != null && d_next[1].indexOf(d[1]) === 0) {
            // Case 2)
 ...
 */
      ...
      /***/ function(module, exports) {
        ...
        EventEmitter.prototype.listeners = function listeners(event, exists) {
          ...
          if (exists) return Boolean(available);
          if (!available) return [];
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        function applyFormat(delta, format, value) {
          if (
            (typeof format === 'undefined' ? 'undefined' : _typeof(format)) === 'object'
          ) {
            ...
            clean: function clean() {
              ...
              if (range.length == 0) {
                ...
                Object.keys(formats).forEach(function(name) {
                  ...
                  if (
                    _parchment2.default.query(name, _parchment2.default.Scope.INLINE) !=
                    null
                  ) {
