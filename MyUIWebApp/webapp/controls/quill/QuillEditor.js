sap.ui.define(['sap/ui/core/Control'], function(Control) {
  ...
  return Control.extend('MyUIWebApp.controls.quill.QuillEditor', {
    metadata: {
      properties: {
    ...
    init: function() {
      ...
      $.sap.require('MyUIWebApp/controls/quill/quill');
    },
    ...
    onAfterRendering: function() {
      ...
      this.setValue = function(value, changedByUser = false) {
        ...
        if (!changedByUser) this.quill.clipboard.dangerouslyPasteHTML(value);
    ...
    renderer: function(oRM, oControl) {
      oRM.write(
        `
			  <div id="` +
          oControl.sId +
          `-standalone-container" style="width:` +
          oControl.getWidth() +
          `">
  				<div id="` +
          oControl.sId +
