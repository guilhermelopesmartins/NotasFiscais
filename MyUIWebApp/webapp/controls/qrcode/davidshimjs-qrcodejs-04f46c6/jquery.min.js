...
(function(e, t) {
  ...
  function Gt(e, t) {
    return (
      (e = t || e), v.css(e, 'display') === 'none' || !v.contains(e.ownerDocument, e)
    );
  }
  function Yt(e, t) {
    var n,
      ...
      for (r = 0; r < o; r++)
        (i = m[r]),
          ...
          i in u ||
            ((u[i] = f.start),
            g &&
              ((f.end = f.start), (f.start = i === 'width' || i === 'height' ? 1 : 0)));
    }
  }
  ...
  (v.fn = v.prototype = {
    ...
    eq: function(e) {
      return (e = Number(e)), e === -1 ? this.slice(e) : this.slice(e, e + 1);
    },
    first: function() {
      return this.eq(0);
    },
    ...
    v.extend({
      ...
      trim:
        d && !d.call('\ufeff\u00a0')
          ...
          : function(e) {
              return e == null ? '' : String(e).replace(b, '');
            },
      ...
      grep: function(e, t, n) {
        var r,
          ...
          o = e.length;
        n = Boolean(n);
        for (; s < o; s++) (r = Boolean(t(e[s], s))), n !== r && i.push(e[s]);
        return i;
      },
      map: function(e, n, r) {
        var i,
    ...
    (v.support = (function() {
      ...
      (s = i.createElement('select')),
        ...
        (t = {
          ...
          htmlSerialize: Boolean(p.getElementsByTagName('link').length),
          style: /top/.test(r.getAttribute('style')),
          hrefNormalized: r.getAttribute('href') === '/a',
          opacity: /^0.5/.test(r.style.opacity),
          cssFloat: Boolean(r.style.cssFloat),
          checkOn: u.value === 'on',
          optSelected: o.selected,
          getSetAttribute: p.className !== 't',
          enctype: Boolean(i.createElement('form').enctype),
  ...
  v.extend({
    ...
    hasData: function(e) {
      return (e = e.nodeType ? v.cache[e[v.expando]] : e[v.expando]), Boolean(e) && !B(e);
    },
  ...
  v.fn.extend({
    ...
    v.support.style ||
      (v.attrHooks.style = {
        ...
        set: function(e, t) {
          return (e.style.cssText = String(t));
        }
      }),
        ...
        u ||
          ((o.handle = u = function(e) {
            return typeof v === 'undefined' ||
              (Boolean(e) && v.event.triggered === e.type)
              ? t
        ...
        (u = nt.contains = y.contains
          ? function(e, t) {
              var n = e.nodeType === 9 ? e.documentElement : e,
                r = t && t.parentNode;
              return (
                e === r || Boolean(r && r.nodeType === 1 && n.contains && n.contains(r))
              );
            }
          : y.compareDocumentPosition
            ? function(e, t) {
                return t && Boolean(e.compareDocumentPosition(t) & 16);
              }
            : function(e, t) {
            ...
            CHILD: function(e) {
              return (
                ...
                e[1] === 'nth'
                  ? (e[2] || nt.error(e[0]),
                    (e[3] = Number(
                      e[3] ? e[4] + (e[5] || 1) : 2 * (e[2] === 'even' || e[2] === 'odd')
                    )),
                    (e[4] = Number(e[6] + e[7] || e[2] === 'odd')))
                  : e[2] && nt.error(e[0]),
                e
              );
            },
  ...
  (v.ajaxSettings.xhr = e.ActiveXObject
    ...
    (function(e) {
      v.extend(v.support, {
        ajax: Boolean(e),
        cors: Boolean(e) && 'withCredentials' in e
      });
    })(v.ajaxSettings.xhr()),
    v.support.ajax &&
      ...
      '*': [
        function(e, t) {
          var n,
            ...
            f = 20;
          if (s) {
            (n = Number(s[2])), (r = s[3] || (v.cssNumber[e] ? '' : 'px'));
            if (r !== 'px' && u) {
      ...
      _default: {
        get: function(e) {
          ...
          return e.elem[e.prop] == null ||
            (Boolean(e.elem.style) && e.elem.style[e.prop] != null)
