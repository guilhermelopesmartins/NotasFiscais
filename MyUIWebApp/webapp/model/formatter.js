sap.ui.define(
  ['MyUIWebApp/src/app/BaseController'],
  function(BaseController) {
    ...
    return {
      ...
      boolToYesNo: function(booleanValue) {
        var resource = this.getView()
          .getModel('i18n')
          .getResourceBundle();
        if (booleanValue) return resource.getText('Commom.Yes');
        return resource.getText('Commom.No');
      },
      yesNoToBool: function(stringYesOrNo) {
        if (stringYesOrNo == 'Y') return true;
        return false;
      },
      yesNoToState: function(stringYesOrNo) {
        if (stringYesOrNo == 'Y') return 'Success';
        return 'None';
      },
      ...
      getStateOfPriority: function(bUrgent) {
        if (bUrgent) return sap.ui.core.ValueState.Error;
      ...
      maxRecordsPerSearch: function(iValue) {
        ...
        if (iValue >= 50 && iValue < 101) {
          return 'None';
        }
        if (iValue >= 101 && iValue < 151) {
          return 'Warning';
        }
        return 'Error';
      },
      ...
      currency: function(amount) {
        ...
        var formated = currencyFormatter.formatValue(
          [amount.toString(), 'R$ '],
          'string'
        );
        return formated;
      ...
      formatNegativePositiveValue: function(nValue) {
        if (nValue < 0) return sap.ui.core.ValueState.Error;
        if (nValue > 0) return sap.ui.core.ValueState.Success;
        return sap.ui.core.ValueState.None;
      },
      percentStateCritical: function(percent) {
        if (percent > 0 && percent < 60) return sap.ui.core.ValueState.Success;
        if (percent >= 60 && percent < 80) return sap.ui.core.ValueState.Warning;
        if (percent >= 80 && percent <= 100) return sap.ui.core.ValueState.Error;
