...
var objType = function objType(obj) {
  ...
  if (type === 'string' || obj instanceof String) return 'string';
  if (type === 'number' || obj instanceof Number) return 'number';
  if (type === 'function' || obj instanceof Function) return 'function';
  if (Boolean(obj) && obj.constructor === Array) return 'array';
  if (obj && obj.nodeType === 1) return 'element';
  ...
  return this.thenList(prereqs).then(function toPdf_main() {
    ...
    for (var page = 0; page < nPages; page++) {
      ...
      if (page === nPages - 1) {
        ...
        pageHeight =
          pageCanvas.height * this.prop.pageSize.inner.width / pageCanvas.width;
      }
...
jsPDF.getPageSize = function(orientation, unit, format) {
  ...
  if (
    (typeof orientation === 'undefined' ? 'undefined' : _typeof(orientation)) === 'object'
  ) {
      ...
      Array.prototype.forEach.call(
        ...
        function(link) {
          ...
          for (var i = 0; i < clientRects.length; i++) {
            ...
            var top =
              this.opt.margin[0] + clientRect.top % this.prop.pageSize.inner.height;
