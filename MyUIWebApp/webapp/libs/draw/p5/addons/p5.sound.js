...
(function(root, factory) {
  ...
  */
    ...
    var isOGGSupported = function() {
      return Boolean(el.canPlayType) && el.canPlayType('audio/ogg; codecs="vorbis"');
    };
    var isMP3Supported = function() {
      return Boolean(el.canPlayType) && el.canPlayType('audio/mpeg;');
    };
    var isWAVSupported = function() {
      return Boolean(el.canPlayType) && el.canPlayType('audio/wav; codecs="1"');
    };
    var isAACSupported = function() {
      return (
        Boolean(el.canPlayType) &&
        (el.canPlayType('audio/x-m4a;') || el.canPlayType('audio/aac;'))
      );
    };
    var isAIFSupported = function() {
      return Boolean(el.canPlayType) && el.canPlayType('audio/x-aiff;');
    };
  ...
  Tone_type_Type = (function(Tone) {
    ...
    Tone.prototype.toFrequency = function(freq) {
      ...
      if (this.isString(freq) || this.isUndef(freq)) {
