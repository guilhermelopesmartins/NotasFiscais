...
!(function(t, e) {
  typeof define === 'function' && define.amd
    ...
    : e(typeof exports === 'object' ? require('../p5') : t.p5);
})(this, function(t) {
  var e;
  e = (function() {
    !(function() {
    ...
    t.prototype.isSupported = function() {
      return Boolean(e.canPlayType);
    };
    var i = function() {
        return Boolean(e.canPlayType) && e.canPlayType('audio/ogg; codecs="vorbis"');
      },
      n = function() {
        return Boolean(e.canPlayType) && e.canPlayType('audio/mpeg;');
      },
      o = function() {
        return Boolean(e.canPlayType) && e.canPlayType('audio/wav; codecs="1"');
      },
      r = function() {
        return (
          Boolean(e.canPlayType) &&
          (e.canPlayType('audio/x-m4a;') || e.canPlayType('audio/aac;'))
        );
      },
      s = function() {
        return Boolean(e.canPlayType) && e.canPlayType('audio/x-aiff;');
      };
  ...
  !(function(t, e) {
    ...
    function n(t, e, i) {
      ...
      else if (typeof t === 'string') n(document.querySelectorAll(t), e, i);
      else if (t.jquery && typeof t.toArray === 'function') n(t.toArray(), e, i);
  ...
  a = (function() {
    var e = o,
      i = e.audiocontext;
    typeof i.createStereoPanner !== 'undefined'
  ...
  u = (function() {
    ...
    (t.SoundFile = function(e, i, n, o) {
      if (typeof e !== 'undefined') {
        if (typeof e === 'string' || typeof e[0] === 'string') {
      ...
      (t.prototype.loadSound = function(e, i, n, o) {
        ...
        var r = this,
          s = new t.SoundFile(
            e,
            function() {
              typeof i === 'function' && i.apply(r, arguments),
                typeof r._decrementPreload === 'function' && r._decrementPreload();
            },
            n,
            o
          );
      ...
      (t.SoundFile.prototype.play = function(t, e, i, n, o) {
        ...
        if (
          (c < 0 && (c = 0),
          (c += u),
          typeof e !== 'undefined' && this.rate(e),
          typeof i !== 'undefined' && this.setVolume(i),
          !this.buffer)
        )
        ...
        if (
          ...
          this.mode !== 'untildone' || !this.isPlaying())
        ) {
          if (
          ...
          o && (o = o <= this.buffer.duration - r ? o : this.buffer.duration),
            this._paused
              ...
              : (this.bufferSourceNode.start(c, r, o), this._counterNode.start(c, r, o)),
            (this._playing = !0),
            (this._paused = !1),
          ...
          var h = function() {
            (this._playing = !1),
              ...
              a.bufferSourceNodes.length === 0 && (a._playing = !1);
          };
      ...
      (t.SoundFile.prototype.playMode = function(t) {
        var e = t.toLowerCase();
        if (e === 'restart' && this.buffer && this.bufferSourceNode)
          for (var i = 0; i < this.bufferSourceNodes.length - 1; i++) {
            var n = p.audiocontext.currentTime;
            this.bufferSourceNodes[i].stop(n);
          }
        if (e !== 'restart' && e !== 'sustain' && e !== 'untildone')
      ...
      (t.SoundFile.prototype.rate = function(t) {
        var e = !1;
        if (typeof t === 'undefined') return this.playbackRate;
        if (
          ((this.playbackRate = t),
          t === 0
            ? (t = 1e-13)
      ...
      (t.SoundFile.prototype.dispose = function() {
        ...
        if (
          (p.soundArray.splice(e, 1), this.stop(t), this.buffer && this.bufferSourceNode)
        ) {
          for (var i = 0; i < this.bufferSourceNodes.length - 1; i++)
    ...
    (t.Amplitude = function(t) {
      ...
      (t.Amplitude.prototype._audioProcess = function(t) {
        for (var e = 0; e < t.inputBuffer.numberOfChannels; e++) {
          for (
            var i, n = t.inputBuffer.getChannelData(e), o = n.length, r = 0, s = 0, a = 0;
            o > a;
            a++
          )
            (i = n[a]),
    ...
    (t.FFT = function(t, i) {
      ...
      (t.FFT.prototype.waveform = function() {
        for (var e, i, n, o = 0; o < arguments.length; o++)
          typeof arguments[o] === 'number' &&
            ((e = arguments[o]), (this.analyser.fftSize = 2 * e)),
            typeof arguments[o] === 'string' && (i = arguments[o]);
      ...
      (t.FFT.prototype.analyze = function() {
        for (var t, e = 0; e < arguments.length; e++)
          typeof arguments[e] === 'number' &&
            ((this.bins = arguments[e]), (this.analyser.fftSize = 2 * this.bins)),
            typeof arguments[e] === 'string' && (t = arguments[e]);
        if (t && t.toLowerCase() === 'db')
          return (
            i(this), this.analyser.getFloatFrequencyData(this.freqDomain), this.freqDomain
          );
            ...
            : t === 'lowMid'
              ...
              : t === 'mid'
                ...
                : t === 'highMid'
                  ...
                  : t === 'treble' && ((t = this.treble[0]), (i = this.treble[1])),
          typeof t !== 'number')
        )
      ...
      (t.FFT.prototype.smooth = function(t) {
        return typeof t !== 'undefined' && (this.smoothing = t), this.smoothing;
      }),
  ...
  h = (function() {
    ...
    (t.prototype.set = function(e, i, n) {
      ...
      (t.prototype.optionsObject = function(t, e, i) {
        var n = {};
        if (t.length === 1 && this.isObject(t[0])) n = t[0];
  ...
  d = (function(t) {
    return (
        ...
        tr: {
          ...
          method: function(t, e, i) {
            ...
            return (
              ...
              e && e !== '0' && (n += this._beatsToUnits(parseFloat(e))),
              i && i !== '0' && (n += this._beatsToUnits(parseFloat(i) / 4)),
              n
            );
          }
        },
      ...
      (t.TimeBase.prototype._parsePrimary = function(t) {
        ...
        if (e && e.value === '(') {
          if (
            (t.next(), (i = this._parseBinary(t)), (e = t.next()), !e || e.value !== ')')
          )
  ...
  m = (function(t) {
    return (
      ...
      (t.Time.prototype.copy = function(e) {
        return (
          t.TimeBase.prototype.copy.call(this, e), (this._plusNow = e._plusNow), this
        );
      }),
      ...
      (t.Time.prototype._toNotationHelper = function(t, e) {
        for (
          ...
          if ((a > 1 - s % 1 && (s += a), (s = Math.floor(s)), s > 0)) {
            if (((n += s === 1 ? e[o] : s.toString() + '*' + e[o]), (t -= s * r), i > t))
              break;
            n += ' + ';
          }
        }
  ...
  b = (function(t) {
    ...
    return (
      ...
      (t.Param.prototype.setRampPoint = function(t) {
        ...
        return e === 0 && (e = this._minOutput), this._param.setValueAtTime(e, t), this;
      }),
      ...
      (t.Param.prototype.setValueCurveAtTime = function(t, e, i) {
        ...
        return (
          this._param.setValueCurveAtTime(t, this.toSeconds(e), this.toSeconds(i)), this
        );
      }),
  ...
  x = (function(t) {
    ...
    return (
      ...
      (t.prototype.createInsOuts = function(e, i) {
        e === 1 ? (this.input = new t.Gain()) : e > 1 && (this.input = new Array(e)),
          i === 1 ? (this.output = new t.Gain()) : i > 1 && (this.output = new Array(e));
      }),
      t.Gain
    );
  })(h, b);
      ...
      (t.Oscillator.prototype.start = function(t, i) {
        ...
        if (!this.started) {
          ...
          for (var s in this._freqMods)
            typeof this._freqMods[s].connect !== 'undefined' &&
  ...
  q = (function(t) {
    ...
    return (
      ...
      (t.TimelineSignal.prototype.exponentialRampToValueAtTime = function(e, i) {
        ...
        n && n.value === 0 && this.setValueAtTime(this._minOutput, n.time),
          (e = this._fromUnits(e));
    ...
    a.setContext(e.audiocontext),
      ...
      (t.Envelope.prototype.setADSR = function(t, e, i, n) {
        (this.aTime = t),
          ...
          (this.sPercent = i || 0),
          (this.dLevel =
            typeof i !== 'undefined' ? i * (this.aLevel - this.rLevel) + this.rLevel : 0),
          (this.rTime = n || 0),
          this._setRampAD(t, e);
      }),
      ...
      (t.Envelope.prototype.ramp = function(t, i, n, o) {
        var r = e.audiocontext.currentTime,
          ...
          c = typeof o !== 'undefined' ? this.checkExpInput(o) : void 0;
        t && this.connection !== t && this.connect(t);
    ...
    return (
      (t.Abs = function() {
        this._abs = this.input = this.output = new t.WaveShaper(function(t) {
          return t === 0 ? 0 : Math.abs(t);
        }, 127);
      }),
      t.extend(t.Abs, t.SignalBase),
      (t.Abs.prototype.dispose = function() {
        return (
          t.prototype.dispose.call(this), this._abs.dispose(), (this._abs = null), this
        );
      }),
      t.Abs
    );
  ...
  j = (function(t) {
    ...
    return (
      ...
      (t.Expr._Expressions = {
        ...
        binary: {
          ...
          '-': {
            ...
            precedence: 1,
            method: function(n, o) {
              return n.length === 1 ? i(t.Negate, n, o) : e(t.Subtract, n, o);
            }
          },
          ...
          for (var i in t.Expr._Expressions) {
            ...
            for (var o in n) {
              var r = n[o],
                s = r.regexp,
                a = e.match(s);
              if (a !== null) return { type: i, value: a[0], method: r.method };
            }
          }
      ...
      (t.Expr.prototype._parseTree = function(e) {
        function i(t, e) {
          return !p(t) && t.type === 'glue' && t.value === e;
        }
        function n(e, i, n) {
          var o = !1,
        ...
        function s() {
          ...
          if (t.type === 'func') return (t = c.next()), a(t);
          if (t.type === 'value')
  ...
  Y = (function() {
    ...
    return (
      ...
      (t.Effect.prototype.drywet = function(t) {
        return (
          typeof t !== 'undefined' && (this._drywet.fade.value = t),
  ...
  Q = (function() {
    ...
    return (
      (t.EQ = function(t) {
        e.call(this), (t = t === 3 || t === 8 ? t : 3);
        var i;
        (i = t === 3 ? Math.pow(2, 3) : 2), (this.bands = []);
  ...
  H = (function() {
    ...
    return (
      ...
      (t.Panner3D.prototype.maxDist = function(t) {
        return (
          typeof t === 'number' && (this.panner.maxDistance = t), this.panner.maxDistance
        );
      }),
      (t.Panner3D.prototype.rolloff = function(t) {
        return (
          typeof t === 'number' && (this.panner.rolloffFactor = t),
      ...
      (t.Listener3D.prototype.orient = function(t, e, i, n, o, r, s) {
        return (
          arguments.length === 3 || arguments.length === 4
            ...
            : (arguments.length === 6 || arguments === 7) &&
          ...
          r = new t.Convolver(
            ...
            function(t) {
              typeof i === 'function' && i(t),
                typeof o._decrementPreload === 'function' && o._decrementPreload();
            },
            n
          );
        return (r.impulses = []), r;
  ...
  nt = (function() {
    ...
    (t.prototype.setBPM = function(t, e) {
      ...
      (t.Part.prototype.addPhrase = function(e, i, n) {
        var o;
        if (arguments.length === 3) o = new t.Phrase(e, i, n);
        else {
  ...
  ot = (function() {
    ...
    return (
      (t.SoundLoop = function(t, n) {
        (this.callback = t),
          (this.musicalTimeMode = typeof this._interval === 'number' ? !1 : !0),
          (this._interval = n || 1),
      ...
      Object.defineProperty(t.SoundLoop.prototype, 'interval', {
        ...
        set: function(t) {
          (this.musicalTimeMode = typeof t === 'Number' ? !1 : !0),
            (this._interval = t),
            this._update();
        }
      }),
  ...
  rt = (function() {
    ...
    return (
      ...
      (t.Compressor.prototype.set = function(t, e, i, n, o) {
        typeof t !== 'undefined' && this.attack(t),
          typeof e !== 'undefined' && this.knee(e),
          typeof i !== 'undefined' && this.ratio(i),
          typeof n !== 'undefined' && this.threshold(n),
          typeof o !== 'undefined' && this.release(o);
      }),
      (t.Compressor.prototype.attack = function(t, e) {
        ...
        return (
          typeof t === 'number'
            ...
            : typeof t !== 'undefined' && t.connect(this.compressor.attack),
      ...
      (t.Compressor.prototype.knee = function(t, e) {
        ...
        return (
          typeof t === 'number'
            ...
            : typeof t !== 'undefined' && t.connect(this.compressor.knee),
      ...
      (t.Compressor.prototype.ratio = function(t, e) {
        ...
        return (
          typeof t === 'number'
            ...
            : typeof t !== 'undefined' && t.connect(this.compressor.ratio),
      ...
      (t.Compressor.prototype.threshold = function(t, e) {
        ...
        return (
          typeof t === 'number'
            ...
            : typeof t !== 'undefined' && t.connect(this.compressor.threshold),
      ...
      (t.Compressor.prototype.release = function(t, e) {
        ...
        return (
          typeof t === 'number'
            ...
            : typeof number !== 'undefined' && t.connect(this.compressor.release),
  ...
  st = (function() {
    ...
    (t.SoundRecorder = function() {
      ...
      (t.SoundRecorder.prototype._mergeBuffers = function(t) {
        for (
          var e = new Float32Array(this.recordedSamples), i = 0, n = t.length, o = 0;
          n > o;
          o++
        ) {
          var r = t[o];
  ...
  pt = (function() {
    ...
    (t.MonoSynth = function() {
      ...
      (t.MonoSynth.prototype.amp = function(t, e) {
        var i = e || 0;
        return (
          typeof t !== 'undefined' && this.oscillator.amp(t, i),
  ...
  ht = (function() {
    ...
    (t.PolySynth = function(n, o) {
      ...
      (t.PolySynth.prototype.noteAttack = function(o, r, s) {
        ...
        if (
          (this.notes[c] &&
            this.notes[c].getValueAtTime(u) !== null &&
        ...
        var l =
          this._voicesInUse._searchBefore(u) === null
            ? 0
      ...
      (t.PolySynth.prototype._updateAfter = function(t, e) {
        if (this._voicesInUse._searchAfter(t) !== null) {
      ...
      (t.PolySynth.prototype.noteRelease = function(t, i) {
        ...
        if (t) {
          var a = n(t);
          if (this.notes[a] && this.notes[a].getValueAtTime(s) !== null) {
  ...
  lt = (function() {
    ...
    (t.Distortion = function(n, o) {
      if ((i.call(this), typeof n === 'undefined' && (n = 0.25), typeof n !== 'number'))
        throw new Error('amount must be a number');
      if ((typeof o === 'undefined' && (o = '2x'), typeof o !== 'string'))
