...
!(function(t, e) {
  ...
  (d.prototype.select = function(t, e) {
    ...
    (d.prototype._wrapElement = function(t) {
      ...
      if (t.tagName !== 'INPUT' || t.type !== 'checkbox')
        return t.tagName === 'VIDEO' || t.tagName === 'AUDIO'
    ...
    return (
      ...
      r.addEventListener('loadedmetadata', function() {
        (l.width = r.videoWidth),
          ...
          l.elt.width === 0 && (l.elt.width = r.videoWidth),
          l.elt.height === 0 && (l.elt.height = r.videoHeight),
          l.presetPlaybackRate &&
            ((l.elt.playbackRate = l.presetPlaybackRate), delete l.presetPlaybackRate),
          (l.loadedmetadata = !0);
      }),
      l
    );
  ...
  ['div', 'p', 'span'].forEach(function(i) {
    ...
    (d.prototype.createImg = function() {
      ...
      return (
        (e.src = i[0]),
        i.length > 1 && typeof i[1] === 'string' && (e.alt = i[1]),
        (e.onload = function() {
          (t.width = e.offsetWidth || e.width),
            (t.height = e.offsetHeight || e.height),
            i.length > 1 && typeof i[1] === 'function'
              ? ((t.fn = i[1]), t.fn())
              : i.length > 1 && typeof i[2] === 'function' && ((t.fn = i[2]), t.fn());
        }),
        (t = c(e, this))
      );
    }),
    ...
    (d.prototype.createSlider = function(t, e, i, n) {
      ...
      return (
        ...
        (r.min = t),
        (r.max = e),
        n === 0 ? (r.step = 1e-18) : n && (r.step = n),
        typeof i === 'number' && (r.value = i),
        c(r, this)
      );
    }),
    ...
    (d.prototype.createCheckbox = function() {
      ...
      if (
        ((i.checked = function() {
          ...
          if (t) {
            if (arguments.length === 0) return t.checked;
    ...
    (d.prototype.createSelect = function() {
      ...
      var e = arguments[0];
      return (
        typeof e === 'object' && e.elt.nodeName === 'SELECT'
          ? ((t = e), (o = this.elt = e.elt))
          : ((o = document.createElement('select')),
            e && typeof e === 'boolean' && o.setAttribute('multiple', 'true'),
            (t = c(o, this))),
        (t.option = function(t, e) {
          ...
          if (void 0 !== i)
            ...
            (r.innerHTML = t),
              arguments.length > 1 ? (r.value = e) : (r.value = t),
              o.appendChild(r);
          }
        }),
      ...
      for (var t, i, e = !0, n = !0, r = 0; r < arguments.length; r++)
        arguments[r] === d.prototype.VIDEO
          ...
          : arguments[r] === d.prototype.AUDIO
            ? (e = !1)
            : typeof arguments[r] === 'object'
              ? (t = arguments[r])
              : typeof arguments[r] === 'function' && (i = arguments[r]);
    ...
    (d.Element.prototype.center = function(t) {
      ...
      return (
        t === 'both' || void 0 === t
          ...
          : t === 'horizontal'
            ? this.position(o / 2, a)
            : t === 'vertical' && this.position(l, s / 2),
    ...
    (d.Element.prototype.style = function(t, e) {
      ...
      } else if (t === 'rotate' || t === 'translate' || t === 'position') {
    ...
    (d.MediaElement.prototype.play = function() {
      ...
      return (
        ...
        (t = (this.elt.readyState > 1 || this.elt.load(), this.elt.play())) &&
          t.catch &&
          t.catch(function(t) {
    ...
    (d.MediaElement.prototype.connect = function(t) {
      var e, i;
      if (typeof d.prototype.getAudioContext === 'function')
